...
import { User, PackageCheck, FilePlus, LogOut } from 'lucide-react';
...
const DashboardCard = ({ icon, title, desc, buttonText }) => (
  <div className="bg-white rounded-xl shadow-md p-6 flex flex-col items-center text-center hover:shadow-lg transition-all">
    ...
    <button className="w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 rounded-lg transition">
      {buttonText}
    </button>
  </div>
);
